...
const defaultLinks: SeoInternalLink[] = [
  {
    href: "/intelligence-artificielle-française",
    label: "Intelligence artificielle pour PME en France",
    text: "Comprendre l'approche nationale de CorsaiManager pour les PME françaises.",
  },
  {
    href: "/services",
    label: "Services IA",
...
export const seoPageEnhancements: Record<string, SeoPageEnhancement> = {
  "ia-française": {
    auditFocus:
      "Cette page cible l'intention large autour de l'intelligence artificielle pour PME en France. Le contenu doit donc rester pédagogique, national et orienté décision dirigeant.",
    deepDive: [
      "Pour une PME française, l'intelligence artificielle devient utile lorsqu'elle répond à une contrainte très concrète : peu de temps disponible, équipes réduites, saisonnalité forte, demandes clients dispersées et besoin de réactivité. La page explique comment passer d'une curiosité générale pour l'IA à une première application mesurable, sans imposer une transformation lourde.",
      "L'enjeu n'est pas seulement technique. Une PME en France doit pouvoir comprendre ce que l'IA change dans son quotidien : qualifier une demande, préparer une réponse, déclencher une relance, classer un document, produire un tableau de bord ou aider un collaborateur à suivre une procédure.",
      ...
      "Le contenu de cette page reste distinct des pages dédiées au CRM, aux assistants vocaux et aux logiciels métier. Ici, l'objectif est de donner une vision d'ensemble : comprendre où l'intelligence artificielle peut créer de la valeur, comment l'intégrer et pourquoi un accompagnement humain à distance facilite l'adoption.",
      "La valeur SEO vient de cette combinaison : une intention nationale claire, des exemples métier, des liens vers les services spécialisés et une réponse complète aux objections fréquentes des dirigeants. La page devient une porte d'entrée vers tout l'écosystème IA de CorsaiManager.",
    ],
    corsicaExamples: [
      "Un prestataire de services peut utiliser l'IA pour trier les demandes entrantes, préparer une réponse commerciale et créer automatiquement une tâche de suivi.",
      "Une PME française peut centraliser les prospects issus du site, du téléphone et de WhatsApp, puis automatiser les relances selon le niveau d'intérêt.",
      "Une entreprise de services peut créer un assistant interne qui explique les procédures, retrouve les informations et réduit les interruptions entre équipes.",
    ...
    internalLinks: [
      {
        href: "/automatisation-ia-française",
        label: "Automatisation IA pour PME en France",
        text: "Approfondir les workflows et les tâches répétitives à automatiser.",
      },
      {
        href: "/crm-ia-française",
        label: "CRM IA pour PME en France",
        text: "Découvrir comment l'IA améliore le suivi commercial national.",
      },
      {
    ...
    specificFaqs: [
      {
        q: "Par quoi commencer avec l'intelligence artificielle pour PME en France ?",
      ...
      {
        q: "Une petite entreprise française peut-elle vraiment rentabiliser l'IA ?",
      ...
      },
      {
        ...
        a: "Oui. Les ateliers, démonstrations et suivis peuvent être organisés à distance, avec une logique nationale pour les entreprises de plusieurs villes et toute la France.",
      },
    ],
  },
  "automatisation-ia-française": {
    auditFocus:
      "Cette page cible les dirigeants qui cherchent à automatiser des tâches précises en France, avec une attente de gains rapides et mesurables.",
    deepDive: [
      "L'automatisation IA pour PME en France répond à un problème fréquent : les équipes passent trop de temps à répéter les mêmes actions alors que la relation client, la vente et la qualité de service demandent de l'attention humaine. La page doit donc montrer comment l'IA soulage l'exécution sans déshumaniser le contact.",
      ...
      "La spécificité française compte dans la priorisation. Les entreprises françaises peuvent avoir des pics saisonniers, des équipes polyvalentes, plusieurs canaux de contact et des déplacements fréquents. L'automatisation doit donc rester robuste, compréhensible et facile à ajuster.",
      ...
      "Pour renforcer l'indexation, la page relie les automatisations aux autres briques du site : CRM IA, assistant téléphonique, applications métier et contact. Chaque lien interne aide Google à comprendre que cette page est un pilier de productivité, pas un simple doublon national.",
    ],
    corsicaExamples: [
      "Un restaurant près d'France peut automatiser les demandes de réservation, les confirmations et les rappels avant le service.",
      "Une entreprise de bâtiment  peut générer une fiche prospect après un appel, puis déclencher une relance si le devis reste sans réponse.",
      "Un centre de formation en France peut automatiser l'envoi des documents, les convocations et les rappels administratifs.",
      "Un commerce national peut consolider les messages reçus par formulaire, email et WhatsApp dans une seule file de traitement.",
    ],
    internalLinks: [
      {
        href: "/ia-française",
        label: "IA pour PME en France",
        text: "Revenir à la vision globale de l'intelligence artificielle pour PME partout en France.",
      },
      {
        href: "/automatisation-entreprise",
  ...
  "assistant-ia-bastia": {
    auditFocus:
      "Cette page cible un besoin national précis : gérer les appels et demandes entrantes  avec un assistant IA.",
    deepDive: [
      "Dans une PME, de nombreuses entreprises reçoivent des appels pendant des rendez-vous, des interventions ou des périodes de forte activité. Un assistant IA permet de capter l'information au moment où elle arrive, de qualifier la demande et de transmettre un résumé exploitable à l'équipe.",
      ...
      "Un bon assistant IA national comprend les scénarios métier : horaires, zones d'intervention, types de demandes, urgence, transfert vers un humain, création de tâche ou envoi d'un compte rendu. Le script est donc conçu avec l'entreprise, puis ajusté après les premiers retours terrain.",
      "La valeur pour le SEO repose sur l'ancrage PME et sur les exemples précis d'usage. La page parle aux commerces, cabinets, prestataires et PME qui veulent améliorer leur réactivité sans recruter une permanence téléphonique complète.",
    ...
    corsicaExamples: [
      "Un cabinet de services  peut qualifier les appels entrants et envoyer un résumé au bon collaborateur.",
      "Une entreprise d'intervention en France peut distinguer les urgences des demandes de devis et prioriser les rappels.",
      "Un commerce peut répondre aux questions fréquentes sur les horaires, disponibilités ou prises de rendez-vous.",
    ...
    specificFaqs: [
      {
        q: "Un assistant IA peut-il répondre hors horaires  ?",
  ...
  "crm-ia-française": {
    auditFocus:
      "Cette page traite du suivi commercial et de la centralisation des prospects pour les PME partout en France.",
    deepDive: [
      "Un CRM IA pour PME en France doit résoudre une difficulté très concrète : les prospects arrivent par plusieurs canaux et le suivi dépend souvent de la mémoire de chacun. L'IA aide à classer, prioriser, relancer et documenter chaque opportunité avec plus de régularité.",
      ...
      "Dans un contexte national, la proximité commerciale reste essentielle. Le CRM IA ne doit pas rendre la relation froide ; il doit au contraire donner plus de contexte avant un appel, rappeler les engagements pris et éviter les oublis après un rendez-vous.",
      "La page apporte un contenu unique grâce aux exemples de PME françaises : prestataires, agents commerciaux, centres de formation, fournisseurs CHR ou services B2B. Chaque cas illustre une étape du cycle de vente et un bénéfice mesurable.",
      "Le maillage interne renvoie vers l'automatisation commerciale, le CRM IA pour PME et la page contact. Cela renforce la cohérence sémantique autour du pilotage commercial, tout en gardant cette URL dédiée à l'intention nationale.",
    ],
    corsicaExamples: [
      "Un fournisseur CHR à France peut prioriser les comptes à relancer avant la saison et suivre les devis ouverts.",
      "Une PME de services  peut centraliser les demandes web, appels et emails dans un pipeline unique.",
      "Un agent commercial itinérant peut recevoir des rappels de suivi après chaque rendez-vous client en France.",
    ...
    internalLinks: [
      ...
      },
      {
        href: "/ia-française",
        label: "IA pour PME en France",
        text: "Replacer le CRM dans une stratégie IA nationale plus large.",
      },
    ],
    specificFaqs: [
      {
  ...
  "application-metier-française": {
    auditFocus:
      "Cette page cible les PME françaises qui ne trouvent pas d'outil standard adapté à leur fonctionnement.",
    deepDive: [
      "Une application métier sur mesure devient pertinente lorsque les équipes multiplient les tableurs, contournent les logiciels existants ou perdent du temps à recopier les mêmes informations. Le contenu doit montrer qu'un outil sur mesure peut rester simple, ciblé et évolutif.",
      ...
      "Pour une PME nationale, une application métier peut gérer des réservations, des dossiers de formation, un suivi client, des documents, des interventions ou des indicateurs. L'objectif est d'épouser le fonctionnement réel de l'entreprise plutôt que forcer les équipes à s'adapter à un logiciel générique.",
      "La page apporte des exemples concrets en France afin d'éviter le contenu abstrait : saisonnalité, multi-sites, interventions terrain, relation client nationale et coordination administrative. Ces angles rendent la page unique par rapport à la version nationale sur le logiciel métier.",
    ...
    corsicaExamples: [
      "Un organisme de formation en France peut gérer sessions, stagiaires, convocations et documents depuis une seule interface.",
      "Une entreprise de maintenance  peut suivre les demandes, interventions, photos et comptes rendus terrain.",
      "Une activité de réservation à France peut synchroniser disponibilités, confirmations et rappels clients.",
  ...
  "automatisation-commerciale": {
    ...
    deepDive: [
      ...
      "Le contenu est unique par rapport aux pages françaises car il se concentre sur les séquences de vente, les emails, les devis, les relances et les indicateurs commerciaux. L'objectif est d'expliquer comment automatiser sans perdre la personnalisation nécessaire à une relation B2B de qualité.",
      ...
      "Même si la page est nationale, des exemples françaises renforcent la crédibilité terrain. Ils montrent que la méthode fonctionne pour des entreprises françaises avec des contraintes concrètes, et pas seulement pour des équipes commerciales très structurées.",
    ...
    corsicaExamples: [
      "Une PME de services à France peut automatiser les relances après devis tout en gardant un ton personnalisé.",
      "Un fournisseur professionnel  peut déclencher des rappels saisonniers pour ses clients récurrents.",
      "Un centre de formation peut relancer automatiquement les candidats qui n'ont pas finalisé leur inscription.",
      "Une entreprise nationale peut prioriser les prospects chauds chaque matin avant la tournée commerciale.",
    ],
    internalLinks: [
      {
      ...
      },
      {
        href: "/crm-ia-française",
        label: "CRM IA pour PME en France",
        text: "Voir l'application nationale du suivi commercial intelligent.",
      },
    ],
    specificFaqs: [
      {
  ...
  "crm-commercial-ia": {
    ...
    internalLinks: [
      ...
      },
      {
        href: "/crm-ia-française",
        label: "CRM IA pour PME en France",
        text: "Consulter la déclinaison nationale pour PME françaises.",
      },
    ],
    specificFaqs: [
      {
  ...
  "logiciel-metier-sur-mesure": {
    ...
    deepDive: [
      ...
      "Le contenu se différencie de la page application métier France par une portée nationale et une réflexion plus large sur l'architecture, l'évolutivité, les droits utilisateurs, les intégrations et la maintenance. Il s'adresse aux dirigeants qui veulent investir dans un outil durable.",
      ...
      "Les exemples françaises servent de cas concrets, mais la page ne dépend pas d'un territoire. Elle montre comment les besoins de terrain peuvent guider un logiciel utile pour la gestion commerciale, les opérations, la formation ou le suivi client.",
      "Le maillage interne relie cette page aux applications métier, à l'application métier France et à l'automatisation PME. Cela aide à distinguer l'intention développement logiciel de l'intention automatisation ou nationale.",
    ],
    corsicaExamples: [
      "Une PME de PME peut remplacer plusieurs tableurs par un logiciel de suivi client et documents.",
      "Un organisme de formation à France peut gérer inscriptions, sessions, présences et documents réglementaires.",
      "Une entreprise terrain en France peut suivre les interventions depuis mobile et générer des comptes rendus.",
      "Un réseau national peut consolider les données de plusieurs sites dans un seul tableau de bord.",
    ],
    internalLinks: [
      {
        href: "/applications-metier",
      ...
      {
        href: "/application-metier-française",
        label: "Application métier sur mesure",
        text: "Consulter la déclinaison nationale pour PME françaises.",
      },
      {
        href: "/automatisation-pme",
  ...
  "automatisation-pme": {
    ...
    deepDive: [
      ...
      "Les exemples françaises donnent une épaisseur terrain : petites équipes, polyvalence, saisonnalité, documents administratifs et coordination à distance. Cette dimension concrète aide la page à éviter les généralités sur la productivité.",
      "Les liens internes dirigent vers l'automatisation entreprise, l'automatisation IA France et le logiciel métier. Cela crée une lecture progressive : comprendre les gains, voir les cas nationaux, puis envisager une solution outillée.",
    ],
    corsicaExamples: [
      "Une PME  peut automatiser l'envoi de documents après validation d'un dossier client.",
      "Un prestataire à France peut générer un reporting hebdomadaire à partir des données commerciales.",
      "Une entreprise de services en France peut créer des alertes internes lorsque certaines demandes restent sans réponse.",
    ...
    internalLinks: [
      ...
      },
      {
        href: "/automatisation-ia-française",
        label: "Automatisation IA pour PME en France",
        text: "Consulter l'approche nationale des automatisations IA.",
      },
      {
        href: "/logiciel-metier-sur-mesure",
        label: "Logiciel métier sur mesure",
