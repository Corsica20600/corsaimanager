  ...
  return (
    <div className="mx-auto max-w-5xl px-5 py-10 sm:px-8">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-3">
        <StatCard label="Score moyen" value={stats.avg_score} />
      ...
      <div className="mt-8 grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="rounded-2xl border border-white/10 bg-zinc-900/60 p-6 backdrop-blur">
          <h2 className="text-xl font-medium text-zinc-100">Actions</h2>
        ...
        <div className="rounded-2xl border border-white/10 bg-zinc-900/60 p-6 backdrop-blur">
          ...
          <p className="mt-4 text-xs text-zinc-500">Positionnement: Automatisation IA concrète pour PME</p>
        </div>
      </div>
    </div>
  );
