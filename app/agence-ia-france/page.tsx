...
const faq = [
  ["Qu'est-ce qu'une agence IA pour PME ?", "Une agence IA pour PME identifie, conçoit et déploie des usages concrets : automatisation, CRM, assistants, applications métier et pilotage des gains."],
  ["Pourquoi faire appel à une agence IA ?", "Elle relie les besoins métier, les outils existants et le ROI attendu pour éviter de choisir une technologie avant d'avoir identifié le bon problème à résoudre."],
  ["Par quoi commencer pour intégrer l'IA dans une PME ?", "Par un audit des tâches répétitives, des outils et des données disponibles. Il permet de prioriser un premier cas d'usage simple, mesurable et adapté aux équipes."],
  ...
  ["Combien coûte un projet d'intelligence artificielle pour une PME ?", "Le budget dépend du périmètre, des intégrations et du niveau de sur-mesure. Un audit permet de comparer les options et de démarrer par un projet proportionné aux gains visés."],
  ["Combien de temps faut-il pour lancer un premier projet ?", "Un premier workflow ou prototype peut souvent être cadré rapidement, puis testé sur un périmètre limité avant un déploiement plus large."],
];
...
export default function AgenceIaFrancePage() {
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Agence IA pour PME en France",
  ...
  const webPageSchema = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Agence IA pour PME en France | CorsaiManager",
    description: "Agence IA spécialisée dans l'accompagnement des PME françaises : audit, automatisation, CRM, assistants IA et applications métier.",
    url: "https://www.corsaimanager.com/agence-ia-france",
    inLanguage: "fr-FR",
    isPartOf: { "@type": "WebSite", name: "CorsaiManager", url: "https://www.corsaimanager.com" },
  };
    ...
    <main className="pb-24 pt-10">
      ...
      <Container>
        <section className="grid gap-10 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <Pill>Agence IA pour PME en France</Pill>
            <h1 className="mt-6 max-w-5xl text-4xl font-semibold tracking-tight text-white sm:text-5xl">
              Agence IA pour PME : automatisez et développez votre entreprise
            </h1>
            <p className="mt-6 text-lg leading-relaxed text-zinc-300">
              CorsaiManager accompagne les PME partout en France avec des solutions métier conçues à partir de vos processus et de votre ROI : automatisation, CRM, assistants IA, téléphonie IA et applications sur mesure. Nous transformons vos irritants quotidiens — relances, appels, documents, données dispersées — en workflows utiles et mesurables.
            </p>
            <p className="mt-4 text-base leading-relaxed text-zinc-400">
              Basé en Corse, CorsaiManager audite vos besoins, relie les outils déjà en place et déploie progressivement une solution que vos équipes peuvent réellement utiliser.
            </p>
          ...
          <div className="rounded-3xl border border-white/10 bg-zinc-900/70 p-6">
            <p className="text-sm font-medium uppercase tracking-[0.18em] text-cyan-200">Parcours de votre projet IA</p>
        ...
        <SeoSection title="Pourquoi faire appel à une agence IA pour PME ?">
        ...
        <SeoSection title="Réalisations : des solutions IA ancrées dans le métier">
          <p>Les réalisations publiques de CorsaiManager partent de problèmes opérationnels identifiables, puis relient une solution à un bénéfice vérifiable :</p>
          <ul className="list-disc space-y-3 pl-5">
            <li><strong>Suivi commercial dispersé</strong> → un CRM unifié avec scoring des opportunités, relances automatisées et pipeline en temps réel → des relances plus régulières et une vision commerciale plus lisible.</li>
            <li><strong>Sessions et documents de formation répartis entre plusieurs outils</strong> → une application métier centralisée avec gestion des pièces, rappels et suivi de conformité → moins de tâches administratives et une traçabilité renforcée.</li>
            <li><strong>Actions de prospection, marketing et CRM difficiles à coordonner</strong> → un cockpit d'agents IA avec validation humaine → des actions préparées plus vite tout en conservant le contrôle.</li>
          </ul>
          <p>Découvrez le contexte, les fonctionnalités et les bénéfices de ces projets dans nos <Link href="/realisations" className="font-medium text-cyan-200 underline underline-offset-4 hover:text-cyan-100">réalisations IA pour PME</Link>.</p>
        </SeoSection>

        <SeoSection title="Comment se déroule un projet IA avec CorsaiManager ?">
          <p>La méthode suit une progression volontairement simple : cadrage du besoin, audit des processus et des données, priorisation selon le ROI, prototype sur un périmètre limité, déploiement, puis optimisation avec les équipes. Elle évite de surdimensionner le projet et permet de valider les gains avant d'élargir le périmètre.</p>
          <p>Une PME peut commencer par un workflow ciblé, puis ajouter un CRM IA, un assistant téléphonique ou une application métier selon les résultats observés. Le ROI se suit avec des indicateurs adaptés : heures économisées, délais de réponse, relances effectuées, opportunités mieux suivies, erreurs évitées, conversions et satisfaction des équipes.</p>
        </SeoSection>

        <SeoSection title="Audit IA : identifier les gains rapides avant d'investir">
        ...
        <SeoSection title="Automatisation IA pour PME et transformation digitale">
        ...
        <SeoSection title="Quel budget et quel ROI pour un projet IA en PME ?">
          <p>Le budget dépend du problème à résoudre, des outils à connecter, de la qualité des données et du niveau de sur-mesure attendu. Plutôt que de promettre un prix ou un résultat standard, CorsaiManager aide à comparer l'effort nécessaire aux gains visés et à choisir un premier périmètre proportionné.</p>
          <p>Un projet est plus facile à piloter lorsqu'il part d'un indicateur précis : temps de saisie, délai de rappel, nombre de relances, erreurs de traitement ou visibilité sur le pipeline. L'audit IA sert à définir ce point de départ et à mesurer l'évolution après le déploiement.</p>
        </SeoSection>
        ...
        <section className="py-10">
          <h2 className="text-3xl font-semibold tracking-tight text-zinc-100">Questions fréquentes sur une agence IA pour PME</h2>
        ...
        <section className="rounded-3xl border border-cyan-300/30 bg-gradient-to-r from-cyan-300/10 via-blue-400/10 to-cyan-200/10 p-8 text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-zinc-100">Identifiez les tâches à automatiser en priorité</h2>
