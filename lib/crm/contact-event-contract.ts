export const CONTACT_EVENT_KINDS = ["EMAIL_SENT", "EMAIL_REPLIED", "EMAIL_BOUNCED", "EMAIL_REJECTED", "DO_NOT_CONTACT", "FOLLOW_UP_SENT", "FOLLOW_UP_SKIPPED", "PROSPECT_DORMANT", "SEQUENCE_REACTIVATED"] as const;
