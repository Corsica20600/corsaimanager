        ...
        messages: [
          {
            role: "system",
            content:
              "Tu reponds uniquement en JSON valide. Tu es direct, precis et specialise en SEO interne pour www.corsaimanager.com, avec un positionnement France entière pour PME françaises.",
          },
